...
export interface ActivePool extends _TypedLiquityContract<ActivePoolCalls, ActivePoolTransactions> {
    ...
    extractEvents(logs: Log[], name: "ActivePoolLUSDDebtUpdated"): _TypedLogDescription<{
        _LUSDDebt: BigNumber;
    }>[];
    ...
    extractEvents(logs: Log[], name: "LUSDBalanceUpdated"): _TypedLogDescription<{
        _newBalance: BigNumber;
    }>[];
...
export interface BorrowerOperations extends _TypedLiquityContract<BorrowerOperationsCalls, BorrowerOperationsTransactions> {
    ...
    extractEvents(logs: Log[], name: "LQTYStakingAddressChanged"): _TypedLogDescription<{
        _lqtyStakingAddress: string;
    }>[];
    extractEvents(logs: Log[], name: "LUSDBorrowingFeePaid"): _TypedLogDescription<{
        _borrower: string;
        _LUSDFee: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "LUSDTokenAddressChanged"): _TypedLogDescription<{
...
export interface CommunityIssuance extends _TypedLiquityContract<CommunityIssuanceCalls, CommunityIssuanceTransactions> {
    ...
    extractEvents(logs: Log[], name: "LQTYTokenAddressSet"): _TypedLogDescription<{
    ...
    extractEvents(logs: Log[], name: "TotalLQTYIssuedUpdated"): _TypedLogDescription<{
        _totalLQTYIssued: BigNumber;
    }>[];
}
...
export interface DefaultPool extends _TypedLiquityContract<DefaultPoolCalls, DefaultPoolTransactions> {
    ...
    extractEvents(logs: Log[], name: "DefaultPoolLUSDDebtUpdated"): _TypedLogDescription<{
        _LUSDDebt: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "ETHBalanceUpdated"): _TypedLogDescription<{
        _newBalance: BigNumber;
...
interface HintHelpersCalls {
    ...
    getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
    getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
    getRedemptionHints(_LUSDamount: BigNumberish, _price: BigNumberish, _maxIterations: BigNumberish, _overrides?: CallOverrides): Promise<{
...
export interface LockupContractFactory extends _TypedLiquityContract<LockupContractFactoryCalls, LockupContractFactoryTransactions> {
    readonly filters: {
        LQTYTokenAddressSet(_lqtyTokenAddress?: null): EventFilter;
    ...
    extractEvents(logs: Log[], name: "LockupContractDeployedThroughFactory"): _TypedLogDescription<{
...
export interface LUSDToken extends _TypedLiquityContract<LUSDTokenCalls, LUSDTokenTransactions> {
    readonly filters: {
        Approval(owner?: string | null, spender?: string | null, value?: null): EventFilter;
        BorrowerOperationsAddressChanged(_newBorrowerOperationsAddress?: null): EventFilter;
    ...
    extractEvents(logs: Log[], name: "LUSDTokenBalanceUpdated"): _TypedLogDescription<{
        _user: string;
        _amount: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{
...
export interface LQTYStaking extends _TypedLiquityContract<LQTYStakingCalls, LQTYStakingTransactions> {
    readonly filters: {
    ...
    extractEvents(logs: Log[], name: "BorrowerOperationsAddressSet"): _TypedLogDescription<{
    ...
    extractEvents(logs: Log[], name: "F_LUSDUpdated"): _TypedLogDescription<{
        _F_LUSD: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "LQTYTokenAddressSet"): _TypedLogDescription<{
        _lqtyTokenAddress: string;
    }>[];
    extractEvents(logs: Log[], name: "LUSDTokenAddressSet"): _TypedLogDescription<{
        _lusdTokenAddress: string;
    }>[];
    extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{
        previousOwner: string;
    ...
    extractEvents(logs: Log[], name: "TotalLQTYStakedUpdated"): _TypedLogDescription<{
        _totalLQTYStaked: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "TroveManagerAddressSet"): _TypedLogDescription<{
...
export interface LQTYToken extends _TypedLiquityContract<LQTYTokenCalls, LQTYTokenTransactions> {
    readonly filters: {
        Approval(owner?: string | null, spender?: string | null, value?: null): EventFilter;
    ...
    extractEvents(logs: Log[], name: "CommunityIssuanceAddressSet"): _TypedLogDescription<{
        _communityIssuanceAddress: string;
    }>[];
    extractEvents(logs: Log[], name: "LQTYStakingAddressSet"): _TypedLogDescription<{
        _lqtyStakingAddress: string;
    }>[];
    extractEvents(logs: Log[], name: "LockupContractFactoryAddressSet"): _TypedLogDescription<{
...
export interface PriceFeed extends _TypedLiquityContract<PriceFeedCalls, PriceFeedTransactions> {
    ...
    extractEvents(logs: Log[], name: "PriceFeedStatusChanged"): _TypedLogDescription<{
        newStatus: number;
    }>[];
}
...
export interface StabilityPool extends _TypedLiquityContract<StabilityPoolCalls, StabilityPoolTransactions> {
    ...
    extractEvents(logs: Log[], name: "LQTYPaidToDepositor"): _TypedLogDescription<{
        _depositor: string;
        _LQTY: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "LQTYPaidToFrontEnd"): _TypedLogDescription<{
        _frontEnd: string;
        _LQTY: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "LUSDTokenAddressChanged"): _TypedLogDescription<{
    ...
    extractEvents(logs: Log[], name: "StabilityPoolLUSDBalanceUpdated"): _TypedLogDescription<{
        _newBalance: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "TroveManagerAddressChanged"): _TypedLogDescription<{
        _newTroveManagerAddress: string;
...
export interface TroveManager extends _TypedLiquityContract<TroveManagerCalls, TroveManagerTransactions> {
    ...
    extractEvents(logs: Log[], name: "LQTYTokenAddressChanged"): _TypedLogDescription<{
        _lqtyTokenAddress: string;
    }>[];
...
export interface Unipool extends _TypedLiquityContract<UnipoolCalls, UnipoolTransactions> {
    ...
    extractEvents(logs: Log[], name: "RewardAdded"): _TypedLogDescription<{
        reward: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "RewardPaid"): _TypedLogDescription<{
        user: string;
        reward: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "Staked"): _TypedLogDescription<{
        user: string;
        amount: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "UniTokenAddressChanged"): _TypedLogDescription<{
        _uniTokenAddress: string;
    }>[];
    extractEvents(logs: Log[], name: "Withdrawn"): _TypedLogDescription<{
        user: string;
        amount: BigNumber;
    }>[];
}
