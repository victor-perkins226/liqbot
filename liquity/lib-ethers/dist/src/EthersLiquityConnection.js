...
const quais_json_1 = __importDefault(require("../deployments/quais.json"));
...
const deployments = {
    ...
    [quais_json_1.default.chainId]: quais_json_1.default,
...
function _connectByChainId(provider, signer, chainId, optionalParams) {
    var _a;
    console.log({ chain: deployments[chainId] });
